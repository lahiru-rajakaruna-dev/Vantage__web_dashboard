    ...
    return <div
        ...
        <Popover>
            <Popover.Trigger class={'aspect-square w-auto h-full rounded-full border-2 border-teal-400/60 overflow-hidden'}>
                <img class={'aspect-square w-12 h-auto rounded-full'}
                    ...
                    ]}>
                        {
                            (item) => {
                                return (
                                    ...
                                    <div class={'px-2 py-2 rounded-md hover:bg-teal-50'}>
                                        <button onClick={item.action}
                                                class={'flex flex-row items-center justify-start gap-2'}>{item.icon()}{item.label}</button>
                                    </div>
                                )
                            }
                        }
